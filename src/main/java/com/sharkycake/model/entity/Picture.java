package com.sharkycake.model.entity;
...
public class Picture implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getOriginalKey() == null ? other.getOriginalKey() == null : this.getOriginalKey().equals(other.getOriginalKey()))
            && (this.getCompressedKey() == null ? other.getCompressedKey() == null : this.getCompressedKey().equals(other.getCompressedKey()))
            && (this.getThumbnailKey() == null ? other.getThumbnailKey() == null : this.getThumbnailKey().equals(other.getThumbnailKey()))
            && (this.getStorageBucket() == null ? other.getStorageBucket() == null : this.getStorageBucket().equals(other.getStorageBucket()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOriginalKey() == null) ? 0 : getOriginalKey().hashCode());
        result = prime * result + ((getCompressedKey() == null) ? 0 : getCompressedKey().hashCode());
        result = prime * result + ((getThumbnailKey() == null) ? 0 : getThumbnailKey().hashCode());
        result = prime * result + ((getStorageBucket() == null) ? 0 : getStorageBucket().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", originalKey=").append(originalKey);
        sb.append(", compressedKey=").append(compressedKey);
        sb.append(", thumbnailKey=").append(thumbnailKey);
        sb.append(", storageBucket=").append(storageBucket);
