package com.sharkycake.space.constant;


/**
 * 空间成员权限常量类，便于后续校验权限时使用
 */
...
//    ========= 新增图片选单常量 ===================
     ...
     * 仅可查看
     */
    String PROOFING_VIEW = "proofing:view";
    /**
     * 管理权限
     */
    String PROOFING_MANAGE = "proofing:manage";
    /**
     * 关闭选单操作
     */
    String PROOFING_CLOSE = "proofing:close";
